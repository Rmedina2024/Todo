        ...
        >
          <div className="flex items-center justify-between relative">
            <button
              ...
              className={
                todo.completed
                  ? "w-6 h-6 absolute border bg-red-500 dark:border-none  rounded-full z-20 cursor-pointer flex justify-center items-center"
                  : "w-6 h-6 absolute border-gradient-br-slate-300-zinc-white gradient-border-1 rounded-full z-20 cursor-pointer hover:border-gray-500 dark:border-gradient-br-grayish-blue-dark-blue dark:hover:border-gradient-br-purple-blue-dark-blue"
              }
            >
