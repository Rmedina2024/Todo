    ...
    <div className="flex flex-col mt-20 max-w-[500px] w-full px-6 sm:px-0 z-50">
      <header className="flex justify-between items-center mb-16">
        <div className=" w-full text-center">
          <h1 className="sm:text-4xl text-3xl font-bold uppercase text-[#ef4444] tracking-[.50em] text-center dark:text-[#ef4444] font-sans">
            Todo List
          </h1>
        </div>
        <div>
      ...
      {todos.length ? (
        <>
          ...
          <div className="text-[#9293a4] text-sm text-center my-16  dark:text-[#777b93]">
            Puedes arrastrar y soltar las tareas para reorganizarlas.
          </div>
        </>
      ) : (
